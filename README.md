...
* **Core Software Engineering Team:**
  * Zeynep Üstün — [@ZeynepUstunn](https://github.com/ZeynepUstunn)
  * Merve Çankaya — [@cankayamerve](https://github.com/cankayamerve)
  * Zeki Furkan Yıldız — [@zekiyildiz](https://github.com/zekiyildiz)
